...
if (currentUser.getRole().equals("RESOURCE_MANAGER")) {
...
System.out.println("\n=== Available Resources ===");
resourceService.getAllResources().values().forEach(resource ->
System.out.println("ID: " + resource.getId() +
", Name: " + resource.getName() +
", Type: " + resource.getType() +
", Cost/Hour: " + resource.getCostPerHour() +
...
currentUser,
selection.getResource(),
selection.getStartTime(),
selection.getEndTime()
);
if (booking != null) {
System.out.println("Booking confirmed for " + selection.getResource().getName() +
", Cost: " + booking.getCost());
} else {
System.out.println("Booking failed for " + selection.getResource().getName() +
...
System.out.println("\n=== Booking Trends ===");
reportService.getBookingTrends().forEach((resource, count) ->
System.out.println("Resource: " + resource + ", Bookings: " + count));

System.out.println("\n=== Your Booking History ===");
reportService.getUserBookingHistory(currentUser.getId()).forEach(booking ->
